...
const EVENT_ITEM = new SimpleInfo("item-tag-event-item", "Objet évenementiel");
...
const items = {
	water: [resource(30), apSource(6), WATER, POISONABLE, poisonableWith("poison"), causes("status_hasdrunk"), usedWith("watergun_opt_empty", "grenade_empty", "bgrenade_empty", "watergun_empty", "concrete", "spices", "water_can_empty", "water_can_1", "water_can_2", "infect_poison_part")],
	pile: [resource(6), usedWith("lamp", "music_part", "coffee_machine", "radio_off", "mixergun_empty", "chainsaw_empty", "pilegun_empty", "taser_empty", "sport_elec_empty", "big_pgun_empty", "vibr_empty", "radius_mk2_part", "pilegun_up_empty", "poison_part", "maglite_off", "maglite_1", "lpoint")],
	...
	pilegun: [watchWeapon(10), new Weapon(1, 90), new Becomes("item_pilegun_empty")],
	taser: [watchWeapon(4), new Weapon(1, 30), new Becomes("taser_empty", 70)],
	...
	lawn: [BULKY, watchWeapon(15), new Weapon(2), new Breakable(20), opens("chest_tools")],
	wrench: [watchWeapon(2), new Weapon(1, 33), new Breakable(20), opens("chest_tools", "chest_food")],
	screw: [watchWeapon(5), new Weapon(1, 20), new Breakable(40), opens("can", "chest", "chest_xl", "chest_tools", "chest_food", "catbox")],
	staff: [watchWeapon(4), new Weapon(1, 40), opens("chest_tools", "chest_food"), new Becomes("item_staff2", 60)],
	knife: [watchWeapon(10), new Weapon(1), new Breakable(33), opens("chest_tools", "chest_food")],
	cutcut: [watchWeapon(5), new Weapon(2), new Breakable(25), opens("chest_tools", "chest_food")],
	small_knife: [watchWeapon(5), new Weapon(1, 15), new Breakable(45), usedWith("pumpkin_raw"), opens("chest_tools")],
	swiss_knife: [watchWeapon(10), new Weapon(1, 15), new Breakable(50), opens("can", "chest", "chest_xl", "chest_tools", "chest_food")],
	cutter: [watchWeapon(10), new Weapon(1, 60), new Breakable(70), usedWith("pet_snake2"), opens("chest_tools", "chest_food")],
	cart: [BULKY, watchWeapon(20), backpackExtension(2)],
	can_opener: [watchWeapon(4), new Weapon(1, 50), new Breakable(100), opens("can", "chest", "chest_xl", "chest_tools", "chest_food", "catbox")],
	bag: [backpackExtension(1)],
	lights: [resource(3), TO_ASSEMBLE, assemble("wood_bad", "torch"), usedWith("pumpkin_off")],
	...
	courroie: [resource(2), usedWith("chainsaw_part", "big_pgun_part")],
	meca_parts: [resource(52), usedWith("chainsaw_part", "mixergun_part", "lawn_part", "coffee_machine_part", "big_pgun_part", "saw_tool_part", "repair_kit_part_raw", "engine_part", "pilegun_upkit", "car_door_part", "wire", "diode")],
	pet_chick: [watchWeapon(8), resource(1), new Weapon(1), ANIMAL, butcher("undef", "undef"), new Becomes("small_remove")],
	pet_pig: [BULKY, watchWeapon(20), resource(3), new Weapon(1), ANIMAL, butcher("undef", "undef", "undef", "undef"), new Becomes("small_remove")],
	pet_rat: [watchWeapon(4), new Weapon(1), ANIMAL, butcher("undef", "undef"), new Becomes("small_remove")],
	pet_dog: [DEFENSE_ITEM, HOME_ITEM, new Weapon(1), ANIMAL, butcher("meat", "meat"), new Special("Empêche les vols"), new Becomes("small_remove", 10)],
	pet_cat: [watchWeapon(10), HOME_ITEM, new Weapon(1), ANIMAL, decoration(5), butcher("meat", "meat"), new Becomes("small_remove", 20)],
	...
	drug: [resource(4), apSource(6), DRUG, POISONABLE, poisonableWith("poison"), causes("status_drugged"), usedWith("infect_poison_part")],
	...
	sheet: [watchWeapon(10), resource(1), CAMPING_ITEM],
	bagxl: [backpackExtension(2)],
	jerrycan: [TO_ASSEMBLE, assemble("water_cleaner", "water"), usedWith("jerrygun_part", "jerrygun_off")],
	wood2: [resource(68), TRANSFORMABLE, transformInto("wood_beam"), usedWith("wood_plate_part", "repair_kit_part_raw")],
	metal: [resource(68), TRANSFORMABLE, transformInto("metal_beam"), usedWith("lawn_part", "cart_part", "coffee_machine_part", "engine_part", "car_door_part")],
	grenade: [watchWeapon(8), new Weapon("2-4"), new Becomes("small_remove")],
	plate: [BULKY, DEFENSE_ITEM, HOME_ITEM, resource(26), CAMPING_ITEM],
	jerrygun_part: [TO_ASSEMBLE, assemble(["jerrycan", "rustine"], "jerrygun")],
	bandage: [HEAL_ITEM, heals("wound1"), causes("status_healed")],
	vodka: [resource(2), apSource(6), ALCOHOL, causes("status_drunk"), usedWith("oilcan")],
	jerrygun_off: [TO_ASSEMBLE, assemble("jerrycan", "jerrygun")],
	explo: [resource(10), usedWith("deto", "wire")],
	hmeat: [watchWeapon(20), resource(4), apSource(6), FOOD, COOKABLE, causes("status_haseaten"), new MayCause({status_ghoul: 10})],
	...
	rustine: [resource(11), usedWith("jerrygun_part", "chainsaw_part", "mixergun_part", "lawn_part", "cart_part", "coffee_machine_part", "deto", "watergun_opt_part", "saw_tool_part", "powder", "repair_kit_part_raw", "engine_part", "pilegun_upkit", "car_door_part", "wire")],
	lawn_part: [BULKY, TO_ASSEMBLE, assemble(["meca_parts", "metal", "rustine"], "lawn")],
	tube: [resource(25), usedWith("cart_part", "coffee_machine_part", "watergun_opt_part", "lens", "diode")],
	cart_part: [BULKY, TO_ASSEMBLE, assemble(["metal", "rustine", "tube"], "cart")],
	pocket_belt: [backpackExtension(1)],
	drug_hero: [resource(1), apSource(8), DRUG, causes("status_drugged")],
	...
	pharma: [resource(9), TO_ASSEMBLE, assemble("pharma", ["xanax", "drug", "drug_hero", "drug_water", "drug_random", "water_cleaner"]), usedWith("pharma", "coffee_machine", "poison_part", "infect_poison_part", "pumpkin_off")],
	plate_raw: [BULKY, TRANSFORMABLE, transformInto("plate")],
	rhum: [apSource(6), ALCOHOL, causes("status_drunk")],
	coffee: [apSource(4)],
	coffee_machine: [BULKY, HOME_ITEM, resource(3), decoration(5), TO_ASSEMBLE, assemble(["pile", "pharma", "wood_bad"], "coffee")],
	coffee_machine_part: [BULKY, TO_ASSEMBLE, assemble(["meca_parts", "metal", "rustine", "tube", "electro", "cyanure"], "coffee_machine")],
	electro: [resource(11), usedWith("music_part", "mixergun_part", "coffee_machine_part", "pilegun_upkit")],
	...
	radio_on: [watchWeapon(-10), HOME_ITEM, resource(6), decoration(2)],
	...
	big_pgun: [watchWeapon(10), new Weapon(2), new Becomes("item_big_pgun_empty", 50)],
	big_pgun_part: [TO_ASSEMBLE, assemble(["courroie", "meca_parts"], "big_pgun_empty")],
	tagger: [resource(1), DISCOVER_ZONE],
	flare: [watchWeapon(-10)],
	jerrygun: [new Weapon(1), new Becomes("item_jerrygun_empty", 15)],
	chair_basic: [BULKY, watchWeapon(8), HOME_ITEM, resource(4), new Weapon(1, 50), decoration(2), new Breakable(50), opens("chest_tools")],
	gun: [HOME_ITEM, decoration(5)],
	machine_gun: [HOME_ITEM, decoration(15)],
	deto: [resource(9), TO_ASSEMBLE, assemble(["explo", "grenade_empty", "rustine"], "bgrenade_empty"), usedWith("watergun_opt_part", "engine_part")],
	concrete: [BULKY, TO_ASSEMBLE, assemble("water", "concrete_wall")],
	concrete_wall: [BULKY, DEFENSE_ITEM, HOME_ITEM, resource(21), new Weapon(1), new Breakable(5)],
	drug_random: [apSource("0, 6, 7"), DRUG, new MayCause({status_drugged: 50, status_addict: 20, status_terror: 20})],
	disinfect: [resource(1), DRUG, HEAL_ITEM, heals("infection"), causes("status_drugged", "status_immune")],
	...
	bone: [watchWeapon(10), new Weapon(1), new Breakable(80), usedWith("engine_part"), opens("chest_tools", "chest_food")],
	wood_beam: [BULKY, resource(71), TRANSFORMABLE, transformInto("wood2")],
	metal_beam: [BULKY, resource(77), TRANSFORMABLE, transformInto("metal")],
	...
	trestle: [BULKY, DEFENSE_ITEM, watchWeapon(4), HOME_ITEM, resource(3), decoration(1), CAMPING_ITEM],
	table: [BULKY, DEFENSE_ITEM, watchWeapon(15), HOME_ITEM, resource(8), decoration(3), CAMPING_ITEM],
	water_cleaner: [resource(1), usedWith("jerrycan", "water_cup_part")],
	...
	machine_1: [BULKY, watchWeapon(19), HOME_ITEM, resource(1), new Weapon(1), decoration(2), new Breakable(40)],
	machine_2: [BULKY, watchWeapon(15), HOME_ITEM, resource(1), new Weapon(1), decoration(2), new Breakable(43)],
	machine_3: [BULKY, watchWeapon(15), HOME_ITEM, new Weapon(1), decoration(2), new Breakable(40)],
	rp_letter: [RP_ITEM],
	rp_scroll: [RP_ITEM],
	rp_manual: [RP_ITEM],
	rp_book2: [RP_ITEM],
	rp_sheets: [RP_ITEM],
	chain: [watchWeapon(8), resource(3), new Weapon(1, 50), new Breakable(25), opens("chest_tools", "chest_food")],
	...
	cigs: [resource(2), HEAL_ITEM, heals("terror"), usedWith("lights"), new Becomes("small_remove", 10)],
	...
	poison_part: [resource(2), TO_ASSEMBLE, assemble(["pile", "pharma"], "poison"), usedWith("fungus")],
	...
	wire: [resource(14), TO_ASSEMBLE, assemble(["meca_parts", "explo", "rustine"], "claymo"), usedWith("diode", "staff2")],
	oilcan: [resource(11), TO_ASSEMBLE, assemble(["vodka", "fungus"], "hmbrew"), usedWith("staff2")],
	lens: [resource(8), TO_ASSEMBLE, assemble("tube", "scope"), usedWith("ryebag")],
	angryc: [HOME_ITEM, new Weapon('?', 50), ANIMAL, decoration(1), butcher("flesh", "flesh"), new MayCause({status_wound1: 50}), new Becomes("small_remove")],
	claymo: [watchWeapon(50), TO_ASSEMBLE, assemble("door_carpet", "trapma")],
	diode: [resource(12), TO_ASSEMBLE, assemble(["maglite_2", "wire", "tube", "meca_parts"], "lpoint")],
	guitar: [watchWeapon(19), HOME_ITEM, resource(1), apSource("0, 1, 2"), decoration(6), new Breakable()],
	...
	scope: [resource(3), new Special("Facilite l'estimation de l'attaque")],
	trapma: [HOME_ITEM, decoration(15)],
	chudol: [HOME_ITEM, decoration(15), TO_ASSEMBLE, assemble("lsd", "chkspk")],
	lilboo: [RP_ITEM],
	ryebag: [resource(15), TO_ASSEMBLE, assemble("lens", "fungus")],
	...
	tekel: [DEFENSE_ITEM, HOME_ITEM, new Weapon(1), ANIMAL, butcher("meat", "meat"), new Special("Empêche les vols"), new Becomes("small_remove", 15)],
	vodka_de: [apSource(6), ALCOHOL, causes("status_drunk")],
	cinema: [BULKY, resource(1), new Weapon(1), new Becomes("item_lens")],
