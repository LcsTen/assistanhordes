...
const items = {
	...
	chair_basic: [BULKY, watchWeapon(8), HOME_ITEM, new Weapon(1, 50), decoration(2), new Breakable(50), opens("chest_tools")],
	...
	concrete_wall: [BULKY, DEFENSE_ITEM, HOME_ITEM, resource(19), new Weapon(1), new Breakable(5)],
	...
	machine_1: [BULKY, watchWeapon(19), HOME_ITEM, new Weapon(1), decoration(2), new Breakable(40)],
	machine_2: [BULKY, watchWeapon(15), HOME_ITEM, new Weapon(1), decoration(2), new Breakable(43)],
	...
	rp_book2: [RP_ITEM],
	rp_sheets: [RP_ITEM],
	chain: [watchWeapon(8), resource(2), new Weapon(1, 50), new Breakable(25), opens("chest_tools", "chest_food")],
