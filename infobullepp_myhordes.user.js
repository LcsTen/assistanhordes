...
const items = {
	...
	pilegun: [watchWeapon(10), weapon("0-1"), new Becomes("item_pilegun_empty")],
	taser: [watchWeapon(4), weapon("0-1"), new Becomes("taser_empty", 80)],
	...
	pet_chick: [watchWeapon(8), weapon(1), ANIMAL, butcher("undef", "undef"), new Becomes("small_remove")],
	pet_pig: [BULKY, watchWeapon(20), weapon(1), ANIMAL, butcher("undef", "undef", "undef", "undef"), new Becomes("small_remove")],
	pet_rat: [watchWeapon(4), weapon(1), ANIMAL, butcher("undef", "undef"), new Becomes("small_remove")],
	pet_dog: [DEFENSE_ITEM, HOME_ITEM, weapon("1+"), ANIMAL, butcher("meat", "meat"), new Special("Empêche les vols"), new Becomes("small_remove", 5)],
	pet_cat: [watchWeapon(10), HOME_ITEM, weapon("1+"), ANIMAL, decoration(5), butcher("meat", "meat"), new Becomes("small_remove", 12)],
	pet_snake: [BULKY, watchWeapon(15), weapon(1), ANIMAL, butcher("meat", "meat", "meat", "meat"), new Becomes("small_remove")],
	...
	grenade: [watchWeapon(8), weapon("1-4"), new Becomes("small_remove")],
	...
	bgrenade: [watchWeapon(20), weapon("5-12"), new Becomes("small_remove")],
	...
	watergun_opt_3: [watchWeapon(8), weapon(1), new Becomes("item_watergun_opt_2")],
	watergun_opt_2: [watchWeapon(8), weapon(1), new Becomes("item_watergun_opt_1")],
	watergun_opt_1: [watchWeapon(8), weapon(1), new Becomes("item_watergun_opt_empty")],
	...
	big_pgun: [watchWeapon(10), weapon(2), new Becomes("item_big_pgun_empty")],
	...
	fence: [HOME_ITEM],
	watergun_3: [watchWeapon(8), weapon(1), new Becomes("item_watergun_2")],
	watergun_2: [watchWeapon(8), weapon(1), new Becomes("item_watergun_1")],
	watergun_1: [watchWeapon(8), weapon(1), new Becomes("item_watergun_empty")],
	watergun_opt_5: [watchWeapon(8), weapon(1), new Becomes("item_watergun_opt_4")],
	watergun_opt_4: [watchWeapon(8), weapon(1), new Becomes("item_watergun_opt_3")],
	...
	pilegun_up: [watchWeapon(11), weapon("1+"), new Becomes("item_pilegun_up_empty", 20)],
	pile_broken: [],
	...
	iphone: [watchWeapon(8), weapon("1-2"), new Becomes(["item_deto", "item_metal_bad", "item_pile_broken", "item_electro"])],
	...
	boomfruit: [watchWeapon(8), weapon("5-9"), new Becomes("small_remove")],
	...
	lpoint2: [weapon(2), new Becomes("lpoint1")],
	lpoint1: [weapon(2), new Becomes("lpoint")],
	...
	tekel: [DEFENSE_ITEM, HOME_ITEM, weapon("1+"), ANIMAL, butcher("meat", "meat"), new Special("Empêche les vols"), new Becomes("small_remove", 5)],
	vodka_de: [apSource(6), ALCOHOL, causes("status_drunk")],
	cinema: [BULKY, weapon(1), new Becomes("item_lens")],
